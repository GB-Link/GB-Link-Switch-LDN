...
#define CONFIG_LDN_PROBE_CHANNEL 1
#define CONFIG_LDN_PROBE_PRIVATE_JOIN 1
#define CONFIG_LDN_PROBE_EXPORT_ADVERTISEMENTS 1
#define CONFIG_LDN_PROBE_CONTROL_PORT 1
#define CONFIG_LDN_PROBE_LEGACY_PHY 1
