...
/* Switch key material and the LDN advertisement/authentication crypto that the PC
   used to own. Keys live in NVS, are written once over the control link, and are
   never read back, logged or compiled into the firmware image. */
...
/* Parse and authenticate a raw LDN advertisement. Returns false when it is not a
   valid, production-security room we can join. */
